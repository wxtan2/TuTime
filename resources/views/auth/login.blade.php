                ...
                <div class="formContainer">
                    ...
                    <form action="{{ route('login') }}" method="post">
                                ...
                                <tr>
                                    <td>
                                        <label class="container">
                                            <input type="radio" checked="checked" value="tutor" name="user" @if (session('statusTutor'))
                                            checked
                                            @endif>
                                    ...
                                    <td>
                                        <label class="container">
                                            <input type="radio" value="student" name="user" @if (session('statusStudent'))
                                            checked
                                            @endif>
                        ...
                        <div class="textContainer" ">
                            <input class=" @error('email') errorBorder @enderror" type="text" id="email"
